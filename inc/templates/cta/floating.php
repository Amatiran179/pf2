...
?>
<div
	class="pf2-cta-floating"
	data-pf2-cta-floating
	data-pf2-cta-floating-key="<?php echo esc_attr( $floating_key ); ?>"
	aria-hidden="true"
	style="position:fixed;bottom:16px;right:16px;z-index:999;"
>
	<button
	        type="button"
	        class="pf2-cta-floating__dismiss"
	        aria-label="<?php esc_attr_e( 'Tutup ajakan bertindak', 'pf2' ); ?>"
	        data-pf2-cta-floating-dismiss
	>
	        &times;
	</button>
	<a
